...
'''
#
# tms.tms_train("../data/Train_p1_p2_update.csv",indexes=[1],main_save_path="../data/model/",
#               stopword_filename="../data/stopwords.txt",svm_type="libsvm",
#               svm_param="-t 2",config_name="title.config",dic_name="title.key",
#               model_name="title.model",train_name="title.train",
#               param_name="title.param",ratio=0.2,seg=2,local_fun="tf",global_fun="idf")


tms.tms_predict_multi("../data/predict.csv",config_files=["../data/model/model/title.config"],
indexes_lists=[[1],[1,2]],result_save_path="../data/model/result/post_0.2_2.result",result_indexes=[0],seg=2)

#tms.tms_analysis("../data/model2/result/post2.result",step=2,output_file="../data/model2/result/post2.analysis",
# min=0,max=1,indexes=[0,1,2],predicted_label_index=0,predicted_value_index=1,true_label_index=2)